...
std::string_view ResourceTypeToString(ResourceType type) {
  switch (type) {
    case ResourceType::kModel:   return "Model";
    case ResourceType::kTexture: return "Texture";
    case ResourceType::kSound:   return "Sound";
    case ResourceType::kScript:  return "Script";
    case ResourceType::kUi:      return "UI";
    case ResourceType::kData:    return "Data";
    case ResourceType::kMap:     return "Map";
    case ResourceType::kUnknown: return "Unknown";
  }
  return "Unknown";
}
...
ResourceType ClassifyExtension(std::string_view extension) {
  ...
  // Models.
  if (ext == ".mdx" || ext == ".mdl") return ResourceType::kModel;
  ...
  // UI.
  if (ext == ".fdf" || ext == ".toc") return ResourceType::kUi;
